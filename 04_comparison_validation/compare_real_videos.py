...
def compare_videos_frame_by_frame(video1_path, video2_path, sample_interval=30):
    ...
    print(f"\n视频1 (clip1): {total1}帧, {fps1:.2f}fps")
    print(f"视频2 (clip2): {total2}帧, {fps2:.2f}fps")
...
def main():
    video1 = Path("/Users/zhangxu/.openclaw/workspace/test_videos/clip1_real.mp4")
    video2 = Path("/Users/zhangxu/.openclaw/workspace/test_videos/clip2_reconstructed_real.mp4")
